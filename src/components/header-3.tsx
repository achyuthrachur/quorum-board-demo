				...
				<div className="flex items-center gap-5">
					...
					<NavigationMenu className="hidden md:flex">
						<NavigationMenuList>
							...
							<NavigationMenuLink className="px-4">Pricing
                            								</NavigationMenuLink>
						</NavigationMenuList>
					</NavigationMenu>
				</div>
